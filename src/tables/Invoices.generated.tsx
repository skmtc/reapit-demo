import { invoiceModel, InvoiceModel, paymentModel, PaymentModel, creditModel, CreditModel, chargeModel, ChargeModel } from 'schemas/index.ts'
import { createColumnHelper, useReactTable, getCoreRowModel, PaginationState } from '@tanstack/react-table'
import { ModelConfig, ColumnsList } from '@/components/ModelRuntimeConfig'
import { match } from 'ts-pattern'
import { useGetApiInvoices, useGetApiInvoicesPayments, useGetApiInvoicesCredits, useGetApiInvoicesCharges } from 'services/Invoices.generated.ts'
import { useMemo, useReducer, useState } from 'react'

export const useInvoicesTableColumnHelper = createColumnHelper<InvoiceModel>();
export type UseInvoicesTableArgs = {sortBy?: string | undefined, negotiatorId?: Array<string> | undefined, propertyId?: Array<string> | undefined, status?: Array<'pending' | 'raised' | 'partPaid' | 'partCredited' | 'credited' | 'paid'> | undefined, dateFrom?: string | undefined, dateTo?: string | undefined, dueDateFrom?: string | undefined, dueDateTo?: string | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, columns: ColumnsList<InvoiceModel>};
...
export type UseInvoicesCreditsTableArgs = {sortBy?: string | undefined, negotiatorId?: Array<string> | undefined, propertyId?: Array<string> | undefined, invoiceId?: Array<string> | undefined, dateFrom?: string | undefined, dateTo?: string | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, columns: ColumnsList<CreditModel>};
...
export type UseInvoicesChargesTableArgs = {sortBy?: string | undefined, negotiatorId?: Array<string> | undefined, propertyId?: Array<string> | undefined, invoiceId?: Array<string> | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, columns: ColumnsList<ChargeModel>};
