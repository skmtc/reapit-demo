import { propertyModel, PropertyModel, certificateModel, CertificateModel, keysModel, KeysModel, keyMovementModel, KeyMovementModel, propertyCheckModel, PropertyCheckModel, propertyAppraisalModel, PropertyAppraisalModel } from 'schemas/index.ts'
import { createColumnHelper, useReactTable, getCoreRowModel, PaginationState } from '@tanstack/react-table'
import { ModelConfig, ColumnsList } from '@/components/ModelRuntimeConfig'
import { match } from 'ts-pattern'
import { useGetApiProperties, useGetApiPropertiesIdCertificates, useGetApiPropertiesIdKeys, useGetApiPropertiesIdKeysKeyIdMovements, useGetApiPropertiesIdChecks, useGetApiPropertiesCertificates, useGetApiPropertiesIdAppraisals } from 'services/Properties.generated.ts'
...
export const getusePropertiesTableColumn = (property:string, modelConfig: ModelConfig<PropertyModel>) => {
      return match(property).with('_embedded', () => {
...
export type UsePropertiesIdCertificatesTableArgs = {id: string, category?: Array<'safetyCertificate' | 'insurancePolicy' | 'warranty'> | undefined, columns: ColumnsList<CertificateModel>};
export const getusePropertiesIdCertificatesTableColumn = (property:string, modelConfig: ModelConfig<CertificateModel>) => {
...
export type UsePropertiesIdKeysKeyIdMovementsTableArgs = {id: string, keyId: string, columns: ColumnsList<KeyMovementModel>};
export const getusePropertiesIdKeysKeyIdMovementsTableColumn = (property:string, modelConfig: ModelConfig<KeyMovementModel>) => {
      return match(property).with('_links', () => {
      const { label: header, format, width, minWidth } = modelConfig['_links']
...
export type UsePropertiesIdChecksTableArgs = {id: string, type?: string | undefined, columns: ColumnsList<PropertyCheckModel>};
...
export type UsePropertiesCertificatesTableArgs = {sortBy?: string | undefined, expiryDateFrom?: string | undefined, expiryDateTo?: string | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, categories?: Array<string> | undefined, typeIds?: Array<string> | undefined, propertyIds?: Array<string> | undefined, embed?: Array<'property'> | undefined, columns: ColumnsList<CertificateModel>};
export const getusePropertiesCertificatesTableColumn = (property:string, modelConfig: ModelConfig<CertificateModel>) => {
      return match(property).with('_links', () => {
      const { label: header, format, width, minWidth } = modelConfig['_links']
...
export const getusePropertiesIdAppraisalsTableColumn = (property:string, modelConfig: ModelConfig<PropertyAppraisalModel>) => {
