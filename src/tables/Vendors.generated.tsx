import { vendorModel, VendorModel, vendorContactRelationshipModel, VendorContactRelationshipModel } from 'schemas/index.ts'
...
export const getuseVendorsIdRelationshipsTableColumn = (property:string, modelConfig: ModelConfig<VendorContactRelationshipModel>) => {
      return match(property).with('_links', () => {
      const { label: header, format, width, minWidth } = modelConfig['_links']
