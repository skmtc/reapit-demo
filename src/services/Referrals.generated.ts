import { CreateReferralModel, UpdateReferralModel, referralModelPagedResult, referralTypeModelPagedResult } from 'schemas/index.ts'
import { z } from 'zod'
import { querySerialiser, defaultQuerySerialiserOptions } from '@/lib/querySerialiser'
import { useMutation, useQueryClient, useQuery, keepPreviousData } from '@tanstack/react-query'
import { useFetchError } from '@/lib/useFetchError.ts'

export type UsePostApiReferralsArgs = {body: CreateReferralModel};
...
export type UseGetApiReferralsArgs = {id?: Array<string> | undefined, propertyId?: Array<string> | undefined, applicantId?: Array<string> | undefined, contactId?: Array<string> | undefined, negotiatorId?: Array<string> | undefined, referralTypeId?: Array<string> | undefined, status?: Array<'sent' | 'inProgress' | 'succeeded' | 'cancelled' | 'failed' | 'paid' | 'declined'> | undefined, embed?: Array<'applicant' | 'contact' | 'negotiator' | 'property' | 'type'> | undefined, pageSize?: number | undefined, pageNumber?: number | undefined, sortBy?: string | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined};
export const getApiReferralsFn = async ({id, propertyId, applicantId, contactId, negotiatorId, referralTypeId, status, embed, pageSize, pageNumber, sortBy, createdFrom, createdTo, modifiedFrom, modifiedTo}: UseGetApiReferralsArgs) => {
...
export type UseGetApiReferralsTypesArgs = {id?: Array<string> | undefined, pageSize?: number | undefined, pageNumber?: number | undefined, sortBy?: string | undefined};
