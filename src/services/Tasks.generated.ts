import { CreateTaskModel, UpdateTaskModel, taskModelPagedResult } from 'schemas/index.ts'
import { z } from 'zod'
import { querySerialiser, defaultQuerySerialiserOptions } from '@/lib/querySerialiser'
import { useMutation, useQueryClient, useQuery, keepPreviousData } from '@tanstack/react-query'
import { useFetchError } from '@/lib/useFetchError.ts'

export type UsePostApiTasksArgs = {body: CreateTaskModel};
...
export type UseGetApiTasksArgs = {pageSize?: number | undefined, pageNumber?: number | undefined, sortBy?: string | undefined, embed?: Array<'applicant' | 'contact' | 'landlord' | 'property' | 'tenancy' | 'type'> | undefined, id?: Array<string> | undefined, applicantId?: Array<string> | undefined, contactId?: Array<string> | undefined, landlordId?: Array<string> | undefined, officeId?: Array<string> | undefined, propertyId?: Array<string> | undefined, recipientId?: Array<string> | undefined, senderId?: Array<string> | undefined, typeId?: Array<string> | undefined, tenancyId?: Array<string> | undefined, activatesFrom?: string | undefined, activatesTo?: string | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, metadata?: Array<string> | undefined};
export const getApiTasksFn = async ({pageSize, pageNumber, sortBy, embed, id, applicantId, contactId, landlordId, officeId, propertyId, recipientId, senderId, typeId, tenancyId, activatesFrom, activatesTo, createdFrom, createdTo, modifiedFrom, modifiedTo, metadata}: UseGetApiTasksArgs) => {
