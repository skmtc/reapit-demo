import { CreateTenancyModel, UpdateTenancyModel, CreateTenancyCheckModel, UpdateTenancyCheckModel, CreateTenancyBreakClauseModel, UpdateTenancyBreakClauseModel, CreateTenancyAllowanceModel, UpdateTenancyAllowanceModel, CreateTenancyResponsibilityModel, UpdateTenancyResponsibilityModel, CreateTenancyRenewalModel, UpdateTenancyRenewalModel, CreateTenancyRenewalCheckModel, UpdateTenancyRenewalCheckModel, tenancyModelPagedResult, tenancyContactRelationshipModelPagedResult, tenancyCheckModelPagedResult, tenancyBreakClauseModelPagedResult, tenancyAllowanceModelPagedResult, tenancyResponsibilityModelPagedResult, tenancyRenewalModelPagedResult, tenancyExtensionAlterationModelPagedResult, tenancyRenewalCheckModelPagedResult } from 'schemas/index.ts'
import { z } from 'zod'
