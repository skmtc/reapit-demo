import { CreateCompanyModel, UpdateCompanyModel, companyModelPagedResult, companyRoleModelPagedResult, staffModelPagedResult } from 'schemas/index.ts'
import { z } from 'zod'
import { querySerialiser, defaultQuerySerialiserOptions } from '@/lib/querySerialiser'
import { useMutation, useQueryClient, useQuery, keepPreviousData } from '@tanstack/react-query'
import { useFetchError } from '@/lib/useFetchError.ts'

export type UsePostApiCompaniesArgs = {body: CreateCompanyModel};
...
export type UseGetApiCompaniesArgs = {pageSize?: number | undefined, pageNumber?: number | undefined, sortBy?: string | undefined, embed?: Array<'companyTypes' | 'relationships'> | undefined, id?: Array<string> | undefined, address?: string | undefined, branch?: string | undefined, name?: string | undefined, typeId?: string | undefined, negotiatorId?: Array<string> | undefined, officeId?: Array<string> | undefined, contactDetail?: Array<string> | undefined, fromArchive?: boolean | undefined, createdFrom?: string | undefined, createdTo?: string | undefined, modifiedFrom?: string | undefined, modifiedTo?: string | undefined, metadata?: Array<string> | undefined};
export const getApiCompaniesFn = async ({pageSize, pageNumber, sortBy, embed, id, address, branch, name, typeId, negotiatorId, officeId, contactDetail, fromArchive, createdFrom, createdTo, modifiedFrom, modifiedTo, metadata}: UseGetApiCompaniesArgs) => {
...
export type UseGetApiCompaniesIdRelationshipsArgs = {id: string, pageSize?: number | undefined, pageNumber?: number | undefined};
export const getApiCompaniesIdRelationshipsFn = async ({id, pageSize, pageNumber}: UseGetApiCompaniesIdRelationshipsArgs) => {
