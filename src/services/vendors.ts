...
export const patchApiVendorsIdFn = async ({ 'If-Match': IfMatch, id, body }: UsePatchApiVendorsIdArgs) => {
  const res = await fetch(`/vendors/${id}${querySerialiser({ args: {}, options: defaultQuerySerialiserOptions })}`, {
    method: 'PATCH',
...
export const postApiVendorsIdRelationshipsFn = async ({ id, body }: UsePostApiVendorsIdRelationshipsArgs) => {
  const res = await fetch(
    `/vendors/${id}/relationships${querySerialiser({ args: {}, options: defaultQuerySerialiserOptions })}`,
    {
      method: 'POST',
...
export const deleteApiVendorsIdRelationshipsRelationshipIdFn = async ({
  ...
  const res = await fetch(
    `/vendors/${id}/relationships/${relationshipId}${querySerialiser({ args: {}, options: defaultQuerySerialiserOptions })}`,
    {
      method: 'DELETE',
