...
export const postApiResthooksFn = async ({ body }: UsePostApiResthooksArgs) => {
  const res = await fetch(`/resthooks/${querySerialiser({ args: {}, options: defaultQuerySerialiserOptions })}`, {
    method: 'POST',
...
export const putApiResthooksIdFn = async ({ id, body }: UsePutApiResthooksIdArgs) => {
  const res = await fetch(`/resthooks/${id}${querySerialiser({ args: {}, options: defaultQuerySerialiserOptions })}`, {
    method: 'PUT',
