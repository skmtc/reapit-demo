import { z } from 'zod'
import { createApplicantBuyingModel, CreateApplicantBuyingModel } from '@/models/createApplicantBuyingModel.ts'
import { createApplicantRentingModel, CreateApplicantRentingModel } from '@/models/createApplicantRentingModel.ts'
