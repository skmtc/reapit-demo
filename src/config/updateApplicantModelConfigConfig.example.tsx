...
import { UpdateApplicantModel } from '@/schemas/updateApplicantModel.generated.tsx'

export const updateApplicantModelConfig: ModelConfig<UpdateApplicantModel> = {marketingMode: {
      key: 'marketingMode',
      label: 'marketingMode',
      format: (value) => `${value}`,
