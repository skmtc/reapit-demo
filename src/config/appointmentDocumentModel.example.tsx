...
export const AppointmentDocumentModel = export const appointmentDocumentModelConfig: ModelConfig<AppointmentDocumentModel> = {draftPropertyInspectionReportId: {
