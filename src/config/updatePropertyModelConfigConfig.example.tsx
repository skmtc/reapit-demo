...
import { UpdatePropertyModel } from '@/schemas/updatePropertyModel.generated.tsx'

export const updatePropertyModelConfig: ModelConfig<UpdatePropertyModel> = {lastCall: {
      key: 'lastCall',
      label: 'lastCall',
      format: (value) => `${value}`,
