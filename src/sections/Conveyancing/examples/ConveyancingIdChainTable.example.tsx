import { useConveyancingIdChainTable } from '@/sections/Conveyancing/tables/ConveyancingTable.generated.tsx'
...
export const ConveyancingIdChainTable = () => {
  ...
  const { rows } = useConveyancingIdChainTable({ fieldNames, id })
