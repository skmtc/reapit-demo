import { createTenancyModel, CreateTenancyModel, updateTenancyModel, UpdateTenancyModel, createTenancyCheckModel, CreateTenancyCheckModel, updateTenancyCheckModel, UpdateTenancyCheckModel, createTenancyBreakClauseModel, CreateTenancyBreakClauseModel, updateTenancyBreakClauseModel, UpdateTenancyBreakClauseModel, createTenancyAllowanceModel, CreateTenancyAllowanceModel, updateTenancyAllowanceModel, UpdateTenancyAllowanceModel, createTenancyResponsibilityModel, CreateTenancyResponsibilityModel, updateTenancyResponsibilityModel, UpdateTenancyResponsibilityModel, createTenancyRenewalModel, CreateTenancyRenewalModel, updateTenancyRenewalModel, UpdateTenancyRenewalModel, createTenancyRenewalCheckModel, CreateTenancyRenewalCheckModel, updateTenancyRenewalCheckModel, UpdateTenancyRenewalCheckModel } from 'schemas/index.ts'
