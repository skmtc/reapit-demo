import { createLandlordModel, CreateLandlordModel, updateLandlordModel, UpdateLandlordModel, insertLandlordContactRelationshipModel, InsertLandlordContactRelationshipModel } from 'schemas/index.ts'
