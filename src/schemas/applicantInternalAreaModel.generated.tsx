...
export const applicantInternalAreaModel =
  /** The applicant's indoor space requirements */
  z.object({
    /** The unit of area that each amount corresponds to (squareFeet/squareMetres) */ type: z.string().optional(),
    /** The unit value of inside space that the applicant is looking for */ amount: z.number().optional(),
  })
/** The applicant's indoor space requirements */
