...
export const createPropertyLettingModel =
  ...
  z.object({
    ...
    /** The date the property is available from */ availableFrom: z.string().optional(),
    ...
    /** Sets the minimum number of months the property can be let out for */ minimumTerm: z.number().int().optional(),
    managementFee: createPropertyCommissionFeeModel.optional(),
    lettingFee: createPropertyCommissionFeeModel.optional(),
    /** The rent qualifier (rentOnApplication/askingRent) */ qualifier: z.string().optional(),
    utilities: createUtilityModel.optional(),
    deposit: createPropertyLettingsDepositModel.optional(),
  })
/** Request body used to set details specific to lettings marketing on a new property */
