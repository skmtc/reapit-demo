...
import { PatchIdentityChecksId } from '@/examples/PatchIdentityChecksIdForm.example.tsx'
import { UpdateIdentityCheckModel } from 'schemas/index.ts'
import { updateIdentityCheckModelConfig } from 'config/index.example.tsx'
...
export const PatchIdentityChecksIdForm = () => {
      ...
      return (
        <Drawer title="Create new updateIdentityCheckModelConfig" onClose={() => navigate('..')}>
