...
import {
  useMetadataMetadataSchemaTable,
  getuseMetadataMetadataSchemaTableColumn,
} from '@/tables/metadataschema.generated.tsx'
...
export const MetadataMetadataSchemaTable = () => {
  const columns: ColumnsList<SchemaModel> = fieldNames.map((col) =>
    getuseMetadataMetadataSchemaTableColumn(col, schemaModelConfig),
  )
