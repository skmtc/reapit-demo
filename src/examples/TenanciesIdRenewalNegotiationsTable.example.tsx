import { useTenanciesIdRenewalNegotiationsTable, getuseTenanciesIdRenewalNegotiationsTableColumn } from '@/tables/Tenancies.generated.tsx'
import { useParams, Link as RouterLink, Outlet } from 'react-router-dom'
import { default as invariant } from 'tiny-invariant'
import { tenancyRenewalModelConfig } from '@/config/tenancyRenewalModelConfigConfig.example.tsx'
...
export const TenanciesIdRenewalNegotiationsTable = () => {
  const columns: ColumnsList<TenancyRenewalModel> = fieldNames.map((col) => getuseTenanciesIdRenewalNegotiationsTableColumn(col, tenancyRenewalModelConfig))
