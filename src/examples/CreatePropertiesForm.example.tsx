...
import { CreateProperties } from '@/examples/CreatePropertiesForm.example.tsx'
import { CreatePropertyModel } from 'schemas/index.ts'
import { createPropertyModelConfig } from 'config/index.example.tsx'
...
export const CreatePropertiesForm = () => {
      ...
      return (
        <Drawer title="Create new createPropertyModelConfig" onClose={() => navigate('..')}>
