...
import { useApplicantsTable, getApplicantsColumn } from '@/tables/applicants.generated.tsx'
import { ApplicantModel } from '@/schemas/index.ts'
import { applicantModelConfig } from '@/config/applicantModel.example.tsx'

const fieldNames = fieldsConfig<ApplicantModel>({
  _links: true,
  _embedded: true,
  id: true,
  created: true,
...
export const Applicants = () => {
  const columns: ColumnsList<ApplicantModel> = fieldNames.map((col) => getApplicantsColumn(col, applicantModelConfig))
