...
import { PatchPropertiesId } from '@/examples/PatchPropertiesIdForm.example.tsx'
import { UpdatePropertyModel } from 'schemas/index.ts'
import { updatePropertyModelConfig } from 'config/index.example.tsx'
...
export const PatchPropertiesIdForm = () => {
      ...
      return (
        <Drawer title="Create new updatePropertyModelConfig" onClose={() => navigate('..')}>
