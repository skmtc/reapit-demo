...
const fieldNames = fieldsConfig<CreateTenancyModel>({
  startDate: true,
  endDate: true,
  status: true,
  agentRole: true,
...
export const CreateTenanciesForm = () => {
  ...
  return (
    <Drawer title="Create new tenancy" onClose={() => navigate('..')}>
...
export const CreateTenanciesFields = () => {
  const formConfig = tenancyModelConfig as ModelConfig<CreateTenancyModel>
