...
import { CreateAppointments } from '@/examples/CreateAppointmentsForm.example.tsx'
import { CreateAppointmentModel } from 'schemas/index.ts'
import { createAppointmentModelConfig } from 'config/index.example.tsx'
...
export const CreateAppointmentsForm = () => {
      ...
      return (
        <Drawer title="Create new createAppointmentModelConfig" onClose={() => navigate('..')}>
