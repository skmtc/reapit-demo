...
import { CreateApplicants } from '@/examples/CreateApplicantsForm.example.tsx'
import { CreateApplicantModel } from 'schemas/index.ts'
import { createApplicantModelConfig } from 'config/index.example.tsx'
...
export const CreateApplicantsForm = () => {
      ...
      return (
        <Drawer title="Create new createApplicantModelConfig" onClose={() => navigate('..')}>
