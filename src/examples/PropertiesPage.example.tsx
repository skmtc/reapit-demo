...
import { usePropertiesTable, getPropertiesColumn } from '@/tables/properties.generated.tsx'
import { PropertyModel } from '@/schemas/index.ts'
import { propertyModelConfig } from '@/config/propertyModel.example.tsx'

const fieldNames = fieldsConfig<PropertyModel>({
  _embedded: true,
  id: true,
  created: true,
  modified: true,
...
export const Properties = () => {
  const columns: ColumnsList<PropertyModel> = fieldNames.map((col) => getPropertiesColumn(col, propertyModelConfig))
