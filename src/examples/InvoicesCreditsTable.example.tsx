...
import { creditModelConfig } from '@/config/creditModelConfigConfig.example.tsx'
...
export const InvoicesCreditsTable = () => {
  const columns: ColumnsList<CreditModel> = fieldNames.map((col) => getuseInvoicesCreditsTableColumn(col, creditModelConfig))
