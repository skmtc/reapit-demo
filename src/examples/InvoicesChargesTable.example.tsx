...
import { chargeModelConfig } from '@/config/chargeModelConfigConfig.example.tsx'
...
export const InvoicesChargesTable = () => {
  const columns: ColumnsList<ChargeModel> = fieldNames.map((col) => getuseInvoicesChargesTableColumn(col, chargeModelConfig))
