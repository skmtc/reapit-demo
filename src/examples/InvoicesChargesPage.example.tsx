...
import { useInvoicesChargesTable, getInvoicesChargesColumn } from '@/tables/invoices.generated.tsx'
...
export const InvoicesCharges = () => {
  const columns: ColumnsList<ChargeModel> = fieldNames.map((col) => getInvoicesChargesColumn(col, chargeModelConfig))
