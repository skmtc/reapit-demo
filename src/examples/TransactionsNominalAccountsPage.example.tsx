...
import {
  useTransactionsNominalAccountsTable,
  getTransactionsNominalAccountsColumn,
} from '@/tables/transactions.generated.tsx'
...
const fieldNames = fieldsConfig<NominalAccountModel>({
  _links: true,
  _embedded: true,
  id: true,
  created: true,
...
export const TransactionsNominalAccounts = () => {
  const columns: ColumnsList<NominalAccountModel> = fieldNames.map((col) =>
    getTransactionsNominalAccountsColumn(col, nominalAccountModelConfig),
  )
