...
import { CreatePropertyImagesReindex } from '@/forms/propertyimages.generated.tsx'
...
const fieldNames = fieldsConfig<ReindexPropertyImagesModel>({
  propertyId: true,
  imageOrder: true,
})
...
export const CreatePropertyImagesReindexForm = () => {
  ...
  return (
    <Drawer title="Create new reindexPropertyImages" onClose={() => navigate('..')}>
