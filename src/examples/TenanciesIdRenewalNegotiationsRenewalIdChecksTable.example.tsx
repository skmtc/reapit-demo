...
import {
  ...
  getuseTenanciesIdRenewalNegotiationsRenewalIdChecksTableColumn,
...
export const TenanciesIdRenewalNegotiationsRenewalIdChecksTable = () => {
  const columns: ColumnsList<TenancyRenewalCheckModel> = fieldNames.map((col) =>
    getuseTenanciesIdRenewalNegotiationsRenewalIdChecksTableColumn(col, tenancyRenewalCheckModelConfig),
  )
