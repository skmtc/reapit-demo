import { useTenanciesIdRenewalNegotiationsRenewalIdChecksTable, getuseTenanciesIdRenewalNegotiationsRenewalIdChecksTableColumn } from '@/tables/Tenancies.generated.tsx'
import { useParams, Link as RouterLink, Outlet } from 'react-router-dom'
import { default as invariant } from 'tiny-invariant'
import { tenancyRenewalCheckModelConfig } from '@/config/tenancyRenewalCheckModelConfigConfig.example.tsx'
...
export const TenanciesIdRenewalNegotiationsRenewalIdChecksTable = () => {
  const columns: ColumnsList<TenancyRenewalCheckModel> = fieldNames.map((col) => getuseTenanciesIdRenewalNegotiationsRenewalIdChecksTableColumn(col, tenancyRenewalCheckModelConfig))
