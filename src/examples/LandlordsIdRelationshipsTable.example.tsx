...
import {
  useLandlordsIdRelationshipsTable,
  getuseLandlordsIdRelationshipsTableColumn,
} from '@/tables/landlords.generated.tsx'
...
export const LandlordsIdRelationshipsTable = () => {
  const columns: ColumnsList<LandlordContactRelationshipModel> = fieldNames.map((col) =>
    getuseLandlordsIdRelationshipsTableColumn(col, landlordContactRelationshipModelConfig),
  )
