...
import { vendorContactRelationshipModelConfig } from '@/config/vendorContactRelationshipModelConfigConfig.example.tsx'
...
export const VendorsIdRelationshipsTable = () => {
  const columns: ColumnsList<VendorContactRelationshipModel> = fieldNames.map((col) => getuseVendorsIdRelationshipsTableColumn(col, vendorContactRelationshipModelConfig))
