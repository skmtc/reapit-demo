...
import { useEnquiriesTable, getEnquiriesColumn } from '@/tables/enquiries.generated.tsx'
...
export const Enquiries = () => {
  const columns: ColumnsList<EnquiryModel> = fieldNames.map((col) => getEnquiriesColumn(col, enquiryModelConfig))
