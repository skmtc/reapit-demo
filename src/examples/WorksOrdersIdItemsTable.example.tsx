import { useWorksOrdersIdItemsTable, getuseWorksOrdersIdItemsTableColumn } from '@/tables/WorksOrders.generated.tsx'
import { useParams, Link as RouterLink, Outlet } from 'react-router-dom'
import { default as invariant } from 'tiny-invariant'
import { worksOrderItemModelConfig } from '@/config/worksOrderItemModelConfigConfig.example.tsx'
...
export const WorksOrdersIdItemsTable = () => {
  const columns: ColumnsList<WorksOrderItemModel> = fieldNames.map((col) => getuseWorksOrdersIdItemsTableColumn(col, worksOrderItemModelConfig))
