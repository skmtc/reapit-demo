...
import { useCompaniesTable, getCompaniesColumn } from '@/tables/companies.generated.tsx'
...
export const Companies = () => {
  const columns: ColumnsList<CompanyModel> = fieldNames.map((col) => getCompaniesColumn(col, companyModelConfig))
