...
import { CreateProperties } from '@/forms/properties.generated.tsx'
import { CreatePropertyModel } from '@/schemas/index.ts'
import { propertyModelConfig } from '@/config/propertyModel.example.tsx'

const fieldNames = fieldsConfig<CreatePropertyModel>({
  lastCall: true,
  nextCall: true,
  marketingMode: true,
  departmentId: true,
...
export const CreatePropertiesForm = () => {
  ...
  return (
    <Drawer title="Create new property" onClose={() => navigate('..')}>
...
export const CreatePropertiesFields = () => {
  const formConfig = propertyModelConfig as ModelConfig<CreatePropertyModel>
