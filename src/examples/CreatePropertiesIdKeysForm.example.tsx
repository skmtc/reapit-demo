...
import { CreatePropertiesIdKeys } from '@/examples/CreatePropertiesIdKeysForm.example.tsx'
import { CreateKeyModel } from 'schemas/index.ts'
import { createKeyModelConfig } from 'config/index.example.tsx'
...
export const CreatePropertiesIdKeysForm = () => {
      ...
      return (
        <Drawer title="Create new createKeyModelConfig" onClose={() => navigate('..')}>
