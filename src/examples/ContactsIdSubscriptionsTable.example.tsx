...
import {
  useContactsIdSubscriptionsTable,
  getuseContactsIdSubscriptionsTableColumn,
} from '@/tables/contacts.generated.tsx'
...
export const ContactsIdSubscriptionsTable = () => {
  const columns: ColumnsList<ContactSubscriptionModel> = fieldNames.map((col) =>
    getuseContactsIdSubscriptionsTableColumn(col, contactSubscriptionModelConfig),
  )
