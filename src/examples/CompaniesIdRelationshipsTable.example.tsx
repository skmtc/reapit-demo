...
import {
  useCompaniesIdRelationshipsTable,
  getuseCompaniesIdRelationshipsTableColumn,
} from '@/tables/companies.generated.tsx'
...
export const CompaniesIdRelationshipsTable = () => {
  const columns: ColumnsList<CompanyRoleModel> = fieldNames.map((col) =>
    getuseCompaniesIdRelationshipsTableColumn(col, companyRoleModelConfig),
  )
