...
import {
  useTenanciesIdRelationshipsTable,
  getuseTenanciesIdRelationshipsTableColumn,
...
export const TenanciesIdRelationshipsTable = () => {
  const columns: ColumnsList<TenancyContactRelationshipModel> = fieldNames.map((col) =>
    getuseTenanciesIdRelationshipsTableColumn(col, tenancyContactRelationshipModelConfig),
  )
