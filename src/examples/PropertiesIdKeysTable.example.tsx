...
import { keysModelConfig } from '@/config/keysModelConfigConfig.example.tsx'
...
export const PropertiesIdKeysTable = () => {
  const columns: ColumnsList<KeysModel> = fieldNames.map((col) => getusePropertiesIdKeysTableColumn(col, keysModelConfig))
